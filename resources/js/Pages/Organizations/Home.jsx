    ...
    */
            ...
            <UserLayout noPadding>
                <div className={editing && "border-[3px] border-red-500"}>
                    ...
                    <section className="h-fit px-5 md:px-12 space-y-3 md:space-y-8">
                        ...
                        <Tile name="About Us">
                            {
                                pageData.find((data) => data.type === "aboutUs")
                                    .data
                            }
                        </Tile>
    ...
    function EditArea() {
        return (
            <div className="absolute inset-0 h-full w-full flex items-center justify-center group hover:border hover:border-red-500">
                <button className="bg-gray-300/50 group-hover:bg-gray-500/80 px-3 py-2 opacity-50 hover:opacity-100 text-black hover:text-white rounded-xl">
                    Edit
                </button>
            </div>
        );
    ...
    function OrganizationMetadata() {
        return (
            <div>
                <div className="text-lg inter font-extrabold">
                    Society of Information Technology Enthusiasts (SITE) [max
                    lines: 3]
                </div>
                <div className="text-sm">210 members</div>
            </div>
