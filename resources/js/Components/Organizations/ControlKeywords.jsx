...
function ControlKeywords({ keywords, className, queryParameters }) {
    ...
    return (
        <div className={`w-full flex flex-wrap gap-2 max-h-20 min-h-12 border-[1px] rounded-md border-gray-500 p-2 relative text-xs overflow-clip group ${className} shadow-md`}>
            <Dialog>
