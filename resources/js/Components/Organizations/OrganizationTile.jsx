    ...
    return (
        ...
        >
            <div className="h-52 md:h-72 aspect-[5/8] relative">
                ...
                {/* <img
                     src={orgIcon}
                     className="absolute right-2 bottom-2 bg-[#EEEEEE] size-14 overflow-hidden rounded-full object-cover"
                 /> */}
                <ImageWithLoader
                    className="size-14 aspect-square rounded-full"
                    div={{
                        className:
                            "absolute size-14 right-2 bottom-2 bg-[#EEEEEE] overflow-hidden",
                    }}
                    img={{
